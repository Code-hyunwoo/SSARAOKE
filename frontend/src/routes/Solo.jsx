...
function Solo ({Nickname}){
    ...
    return (
        <div className={styles.room}>
            ...
            <Musicbar />
            <MirrorBall />
            <Screen mode={styles.ScreenSolo} now={nowPlaymusic} nextMusic={nextMusic}/>
            ...
            <div className={styles.SoloChatBox}>
                <RoomChat mode={styles.SoloChat} sendChat={sendChat} chatArr={chatArr}/>
            </div>
            ...
            <Button text={"마이크"} getOnClick={audioMute}/>
                ...
                <button onClick={leaveRoom} className={styles.btn,  styles.neon} ><Link to='/lobby' id={styles.btn_no}> 나가기</Link></button>
            </div> 
        </div>
    ) 
}
...
export default connect(mapStateToProps, null)(Solo);