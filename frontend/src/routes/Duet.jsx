...
function Duet ({Nickname}){
  ...
  return (
    <div className={styles.room}>
      ...
      <Musicbar />
      <MirrorBall />
      <Screen mode={styles.ScreenFree} now={nowPlaymusic} nextMusic={nextMusic} />
      ...
      <div className={styles.FreeChatBox}>
        <RoomChat mode={styles.FreeChat} sendChat={sendChat} chatArr={chatArr} />
      </div>
...
export default connect(mapStateToProps, null)(Duet);