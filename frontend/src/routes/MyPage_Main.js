        ...
        <div>
            ...
            <div className={Styles.machineOutline}>
                ...
                <div className={Styles.machineInline}>
                    ...
                    >
                        {/* 툴팁 */}
                    <OverlayTrigger delay={{hide:5, show:5}} overlay={(props) => (<Tooltip {...props}> Click me!</Tooltip>)}  placement="right">
                        <div>
                        <div>
                        <div 
                            style={bookMShow? {position: 'absolute',
                            width: '62vw',
                            height: '20vh',
                            left:'0.5vw',
                            top: '1vh',
                        ...
                        <button className={Stylescan.canPink} style={{top:'6%',left: '4%'}}></button>
                        <button className={Stylescan.canY} style={{top:'6%', left: '17.5%'}}></button>
                        <button className={Stylescan.canP} style={{top:'6%', left: '31%'}}></button>
                        <button className={Stylescan.canB} style={{top:'6%', left: '45%'}}></button>
                        <button className={Stylescan.canR} style={{top:'6%', left: '59%'}}></button>
                        <button className={Stylescan.canN} style={{top:'6%', left: '72%'}}></button>
                        <button className={Stylescan.canBB} style={{top:'6%', left: '86%'}}></button>
                        {/* <Bookmark
                            show={bookmarkShow}
                    ...
                    {/* 아랫층 캔 */}
                    {/* 모달, 마우스오버/아웃 */}
                    <div onClick={() => setVideoShow(true)} onMouseOver={() => setVideoMShow(true)} onMouseOut={() => setVideoMShow(false)}>
                        <div>
                        <div>
                        <div>
                        <div>
                    ...
                    <OverlayTrigger delay={{hide:5, show:5}} overlay={(props) => (<Tooltip {...props}> Click me!</Tooltip>)}  placement="right">
                        {/* 마우스오버 */}
                        <div 
                            style={videoMShow? {position: 'absolute',
                                width: '62vw',
                                height: '20vh',
                                left:'0.5vw',
                                top: '17vh',
