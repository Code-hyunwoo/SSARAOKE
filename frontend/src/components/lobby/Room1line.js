...
function Room1line() {
  return (
    <div>
      <div>
        <div
          className={Styles.roomsamecss}
          style={{ left: "5.95vw", top: "30vh" }}
        >
          {/* <video id="" controls 
          ...
          <div joinbtn className={Styles.roomfull}>
            {" "}
            8/8{" "}
          </div>
          <div className={Styles.tag}> #2010 #K-POP #발라드 #팝 </div>
          <Link to="/basic" className={Styles.joindeco}>
        ...
        >
          ...
          <div className={Styles.roomuser}> {`user_nickname`}</div>
