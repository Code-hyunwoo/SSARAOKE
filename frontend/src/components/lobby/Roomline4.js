...
function Roomline4() {
    ...
    return(
        <div>
            ...
            <div>
                <div className={Styles.doorLD} style={{left: '6%', top: '144%'}}>
                ...
                <div className={Styles.doorML} style={{left: '36%', top: '144%'}} >
                ...
                <div className={Styles.doorMR} style={{left: '50.8%', top: '144%'}} >
                    <img className={Styles.video} src={free} alt="thumbnail" />
                    <div 
                        className={Styles.roomtitle} >
                    </div>
                ...
                <div className={Styles.doorRD}  style={{right: '6%', top: '144%'}}>
