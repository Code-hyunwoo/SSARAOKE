...
function Roomline5() {
    ...
    return(
        <div>
            ...
            <div>
                <div className={Styles.roomsamecss} style={{left: '5.95vw', top: '182vh'}}>
                ...
                <div className={Styles.roomsamecss} style={{left: '35.25vw', top: '182vh'}} >
                ...
                <div className={Styles.roomsamecss} style={{left: '50.25vw', top: '182vh'}} >
                    <img className={Styles.video} src={free} alt="thumbnail" />
                    <div 
                        className={Styles.roomtitle} >
                    </div>
                ...
                <div className={Styles.roomsamecss}  style={{right: '5.95vw', top: '182vh'}}>
