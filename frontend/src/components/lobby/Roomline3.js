...
function Roomline3() {
    ...
    return(
        <div>
            ...
            <div>
                <div className={Styles.doorLD, Styles.roomsamecss} style={{left: '6%', top: '106%'}}>
                    {/* <video id="" controls 
                ...
                <div className={Styles.doorML, Styles.roomsamecss} style={{left: '36%', top: '106%'}}>
                    {/* <video id="" controls 
                        className={Styles.video}>
                        <source src='?'></source>
                    </video> */}
                ...
                <div className={Styles.doorMR, Styles.roomsamecss} style={{left: '50.8%', top: '106%'}}>
                    {/* <video id="" controls 
                        className={Styles.video} >
                        <source src='?'></source>
                    </video> */}
                ...
                <div className={Styles.doorRD, Styles.roomsamecss} style={{right: '6%', top: '106%'}}>
                    {/* <video id="" controls 
                        className={Styles.video} >
                        <source src='?'></source>
                    </video> */}
