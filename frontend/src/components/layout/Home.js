  ...
  return (
    <Container fluid className="px-5">
      ...
      <Row className="mx-5" data-aos="fade-right">
        ...
        <Col md={{ span: 4, offset: 2 }}>
          <div className={styles.desc}>
            (싸라오케 이런것도 됩니다1) Lorem ipsum dolor sit amet, consectetur
            adipiscing elit. Nunc dignissim in mauris in feugiat.
          </div>
        </Col>
      </Row>
      <hr className={styles.line} />
      ...
      <Row className="mx-5" data-aos="fade-left">
        <Col md={{ span: 4, offset: 1 }}>
          <div className={styles.desc}>
            (싸라오케 이런것도 됩니다2) Lorem ipsum dolor sit amet, consectetur
            adipiscing elit. Nunc dignissim in mauris in feugiat.
          </div>
        </Col>
        <Col md={{ span: 4, offset: 2 }}>
      ...
      <Row className="mx-5" data-aos="fade-right">
        ...
        <Col md={{ span: 4, offset: 2 }}>
          <div className={styles.desc}>
            (싸라오케 이런것도 됩니다3) Lorem ipsum dolor sit amet, consectetur
            adipiscing elit. Nunc dignissim in mauris in feugiat.
          </div>
        </Col>
      </Row>
      ...
      <Row className="mx-5" data-aos="fade-left">
        <Col md={{ span: 4, offset: 1 }}>
          <div className={styles.desc}>
            (싸라오케 이런것도 됩니다4) Lorem ipsum dolor sit amet, consectetur
            adipiscing elit. Nunc dignissim in mauris in feugiat.
          </div>
        </Col>
        <Col md={{ span: 4, offset: 2 }}>
      ...
      <Row className="mx-5" data-aos="fade-right">
        ...
        <Col md={{ span: 4, offset: 2 }}>
          <div className={styles.desc}>
            (싸라오케 이런것도 됩니다5) Lorem ipsum dolor sit amet, consectetur
            adipiscing elit. Nunc dignissim in mauris in feugiat.
          </div>
        </Col>
      </Row>
